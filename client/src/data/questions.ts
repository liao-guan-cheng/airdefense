...
export const questions: Question[] = [
  // 第一主軸：防空避難觀念宣導 (category: 'concept')
  {
    id: 'concept-1',
    category: 'concept',
    question: '本次2026年南部地區舉行的城鎮韌性演習，其確切的實施時間點為何？',
    options: [
      '(A) 2026年8月7日09時30分至10時',
      '(B) 2026年8月7日10時至10時30分',
      '(C) 2026年8月7日14時至14時30分',
      '(D) 2026年8月7日15時至16時'
    ],
    correctAnswer: 1
  },
  ...
  },
  {
    id: 'concept-4',
    category: 'concept',
    question: '關於演習的防空警報訊號，當聽到「1長音2短音，長音15秒、短音5秒，間隔5秒，連拉3次，合計115秒的防空警報聲響」或是接獲手機「國家級警報」簡訊時，這代表什麼意思？',
    options: [
